#!/usr/bin/env python3
"""Final clean plot: last sample per window + structural response."""
...
fig.suptitle(f"Cosim forces (end-of-window) — Wg0={GUST_W0:.0f} m/s, U∞={U_INF:.0f} m/s", fontweight="bold")
...
fig.savefig("figures/gust_response_final.png", dpi=150, bbox_inches="tight")
print("Saved → figures/gust_response_final.png")
